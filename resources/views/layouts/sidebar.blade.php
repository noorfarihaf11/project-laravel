<div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
        <a href="/dashboard/profile">
            <img src="/assets/compiled/jpg/1.jpg" alt="Face 1"
                style="border-radius: 50%; overflow: hidden; height: 60px; width: 60px;" alt="Default Profile Image">
        </a>


        <h5 class="font-bold" style="margin-left:75px;margin-top:-58px">{{ $user->name }}</h5>
        <h6 class="text-muted mb-0 "style="margin-left:75px">{{ $user->username }}</h6>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            <li class="sidebar-title" style="font-weight: bold;"> User </li>
            @foreach ($menus->where('id_level', 1) as $menu)
            ...
            @if (auth()->check())
                <li class="sidebar-title" style="font-weight: bold;">{{ auth()->user()->hasRole->name }}</li>
                @foreach ($menus->where('id_level', 2) as $menu)
                    @if ($menu->isAccessibleFor(auth()->user()))
                        <li class="sidebar-item {{ Request::is($menu->menu_link) ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ url($menu->menu_link) }}">
                                <i class="{{ $menu->menu_icon }}"></i>
                                <span>{{ $menu->menu_name }}</span>
        ...
        @can('admin')
            ...
            {{-- <li class="sidebar-item {{ Request::is('dashboard/categories*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item {{ Request::is('dashboard/menus*') ? 'active' : '' }}">
                    <a href="/dashboard/menus" class="sidebar-link">
        ...
        {{-- <li
            ...
            <ul class="submenu ">
                ...
                <li class="submenu-item  ">
                    <a href="/login" class="submenu-link">Logout</a>
